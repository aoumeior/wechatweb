  ...
  <div class="am-collapse am-topbar-collapse" id="doc-topbar-collapse">
    ...
    <div class="am-topbar-right">
      <div class="am-dropdown" data-am-dropdown="{boundary: '.am-topbar'}">
        <button class="am-btn am-btn-secondary am-topbar-btn am-btn-sm am-dropdown-toggle" data-am-dropdown-toggle v-on:click="otherlist=!otherlist">其他 <span class="am-icon-caret-down"></span></button>
    ...
    <div class="am-topbar-right">
      <button class="am-btn am-btn-primary am-topbar-btn am-btn-sm" v-on:click="skiplogin">登录</button>
    </div>
  </div>
</header>
</template>
